<h1 align="center"> 🚀 C++ Básico </h1>

## ✍️ Descrição
Exemplificação da sintaxe geral e básica da Linguagem C++
...
1. Clone:
    ...
    ```bash
    git clone git@github.com:cleibp/basic-cplusplus.git
    ```
1. Download:
    ### Download Manual
...
## 👋🏽 DEMO
[REPLIT](https://replit.com/@cleibp/Basic-Cplusplus#main.cpp) 
